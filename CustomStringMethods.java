...
/* Client provides a single word as orig and the method returns a String that represents orig
  ...
  */
  public String pigLatin(String orig) {
        String add = orig.substring(0, 1);
        String body = orig.substring(1);
        body = body + add + "ay";
        return body;
      }
  ...
  public String removeCharacter(String myString, int removeIdx) {
    if (myString.length() - 1 >= removeIdx){
        String firstHalf = myString.substring(0, removeIdx);
        String secondHalf = myString.substring(removeIdx + 1);
  ...
  */
  public String endUp(String myString, int numToCap){
    ...
    if(numToCap>strLength){
        return myString.toUpperCase();
    } else{
        String endStr = myString.substring(strLength - numToCap);
        return myString.substring(0,strLength-numToCap) + endStr.toUpperCase();
    }
  }
  ...
  */
  public String yellOrWhisper(String myString) {
    ...
    boolean check = Character.isUpperCase(firstLetter.charAt(0));
